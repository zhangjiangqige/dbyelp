...
split_params = {
    'review_count': [0, 50, 100, 9000],
    'fans': [0, 1000, 2000, 3000],
    'average_stars': [0, 0.5, 1.5, 2.5, 3.5, 4.5, 5],
    'useful_prop': [0, 10, 15, 500]
}
...
def building(params):
    ...
    for k, v in params.items():
        L[k] = [vi[0] for vi in v]
    logger.info('decision tree parameters: {}'.format(L))
